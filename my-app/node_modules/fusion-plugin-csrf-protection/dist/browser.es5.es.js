...
var CsrfExpireToken = createToken('CsrfExpireToken');
var CsrfIgnoreRoutesToken = createToken('CsrfIgnoreRoutesToken');
var FetchForCsrfToken = createToken('FetchForCsrfToken');
...
var plugin$2 = true && createPlugin({
  ...
  provides: function provides(_ref) {
    ...
    var token = tokenElement ? JSON.parse(unescape(tokenElement.textContent)) : '';
